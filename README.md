...
基于全面调研识别出 6 个研究机会，**所有机会均经过文献验证**：

1. ★ **DuCa "随机 ≈ 重要性" 理论推广** ✅确认空白 — 5+ 独立发现（DuCa/DART/DivPrune）等待统一理论
2. **少步模型缓存失效** ⚠️半空白 — DisCa(2026.02)已部分研究，但多方法×多模型全矩阵缺失
3. **长视频加速 Scaling 规律** ✅确认空白 — 主流方法全在 2-5s 验证，无长度 scaling 曲线
4. **自适应组合框架** ✅确认空白 — DiffAgent(2026.01)仅图像，无视频多方法配置选择
5. **统一 benchmark** ✅确认空白 — DiffBench 仅图像，无视频加速跨方向对比
6. **消费级 GPU 优化** ⚠️半空白 — 社区工具丰富(Wan2GP/ComfyUI)，缺系统性学术研究

> 详细分析、已有相关工作、实验方案设计见 [docs/07-research-opportunities.md](docs/07-research-opportunities.md)
